...
const members = [
  { name: "Atharva", role: "Team Manager", bio: "Mechanical Engineering major" },
  { name: "Riley", role: "Designer", bio: "Civil Engineering major" },
  { name: "Reese", role: "Materials Procurement", bio: "Industrial Engineering major" },
  { name: "Madelynn", role: "Modeler", bio: "Aerospace Engineering major" },
]
...
const TeamCard = ({ member, idx }) => (
  ...
  >
    ...
    <div className="relative mb-8 w-24 h-24 rounded-3xl bg-slate-50 flex items-center justify-center text-5xl font-black text-ncsu-red italic border-2 border-dashed border-ncsu-red/20 group-hover:border-ncsu-red/40 transition-colors shadow-inner">
      {member.name[0]}
    </div>
